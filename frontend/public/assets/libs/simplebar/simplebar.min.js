    ...
    var H = k
      ...
      , X = function() {
        function t(e, i) {
            ...
            this.classNames = A(A({}, t.defaultOptions.classNames), i.classNames),
            this.axis = {
                x: {
            ...
            this.onMouseMove = function(t, e, i) {
                ...
                if ("function" != typeof t)
                    throw new TypeError("Expected a function");
                return f(i) && (s = "leading"in i ? !!i.leading : s,
      ...
      , $ = function(e) {
        ...
        i.prototype.initDOM = function() {
            ...
            if (!Array.prototype.filter.call(this.el.children, (function(t) {
                ...
                null === (t = this.contentWrapperEl) || void 0 === t || t.setAttribute("tabindex", this.options.tabIndex.toString()),
