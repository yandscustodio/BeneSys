...
!function(e, t) {
    ...
    var s, o = "ADD_CHOICE", r = "REMOVE_CHOICE", c = "FILTER_CHOICES", a = "ACTIVATE_CHOICES", h = "CLEAR_CHOICES", l = "ADD_GROUP", u = "ADD_ITEM", d = "REMOVE_ITEM", p = "HIGHLIGHT_ITEM", f = "search", m = "removeItem", g = "highlightItem", v = ["fuseOptions", "classNames"], _ = "select-one", y = "select-multiple", b = function(e) {
        return {
            type: r,
            choice: e
        }
    ...
    function(e) {
        ...
        return e.prototype.show = function() {
            return F(this.element, this.classNames.activeState),
        ...
        e.prototype.hide = function() {
            return D(this.element, this.classNames.activeState),
        ...
        e.prototype.open = function(e, t) {
            ...
            this.element.setAttribute("aria-expanded", "true"),
            this.isOpen = !0,
            this.shouldFlip(e, t) && (F(this.element, this.classNames.flippedState),
            this.isFlipped = !0)
        }
        ,
        e.prototype.close = function() {
            ...
            this.isOpen = !1,
            this.isFlipped && (D(this.element, this.classNames.flippedState),
            this.isFlipped = !1)
        }
        ,
        ...
        items: function(e, t, i) {
            ...
            case p:
                ...
                h && h.highlighted !== a && (h.highlighted = a,
                i && function(e, t, i) {
                    var n = e.itemEl;
                    n && (D(n, i),
                    F(n, t))
        ...
        ,
        e
    }(), Y = "no-choices", Z = "no-results", ee = "add-choice";
    function te(e, t, i) {
        return (t = function(e) {
            var t = function(e) {
    ...
    function me(e) {
        ...
        if (oe(e) || se(e))
            ...
            if (!pe.call(e, "name"))
                throw new Error(ue("name"));
            const r = e.name;
            if (n = r,
            pe.call(e, "weight") && (s = e.weight,
            s <= 0))
    ...
    const be = /[^ ]+/g;
    class Ee {
        constructor({getFn: e=ye.getFn, fieldNormWeight: t=ye.fieldNormWeight}={}) {
        ...
        create() {
            ...
            oe(this.docs[0]) ? this.docs.forEach(( (e, t) => {
                this._addString(e, t)
            }
    ...
    function Ce(e, t, {getFn: i=ye.getFn, fieldNormWeight: n=ye.fieldNormWeight}={}) {
        const s = new Ee({
            getFn: i,
            fieldNormWeight: n
        });
        return s.setKeys(e.map(me)),
        s.setSources(t),
        s.create(),
        s
    }
    function Se(e, {errors: t=0, currentLocation: i=0, expectedLocation: n=0, distance: s=ye.distance, ignoreLocation: o=ye.ignoreLocation}={}) {
        const r = t / e.length;
        if (o)
            return r;
    ...
    class xe {
        constructor(e, {location: t=ye.location, threshold: i=ye.threshold, distance: n=ye.distance, includeMatches: s=ye.includeMatches, findAllMatches: o=ye.findAllMatches, minMatchCharLength: r=ye.minMatchCharLength, isCaseSensitive: c=ye.isCaseSensitive, ignoreLocation: a=ye.ignoreLocation}={}) {
            if (this.options = {
                location: t,
                threshold: i,
                distance: n,
        ...
        searchIn(e) {
            ...
            this.chunks.forEach(( ({pattern: t, alphabet: d, startIndex: p}) => {
                const {isMatch: f, score: m, indices: g} = function(e, t, i, {location: n=ye.location, distance: s=ye.distance, threshold: o=ye.threshold, findAllMatches: r=ye.findAllMatches, minMatchCharLength: c=ye.minMatchCharLength, includeMatches: a=ye.includeMatches, ignoreLocation: h=ye.ignoreLocation}={}) {
                    if (t.length > we)
    ...
    function He(e, t) {
        ...
        t.matches = [],
        ae(i) && i.forEach((e => {
            if (!ae(e.indices) || !e.indices.length)
                return;
    ...
    class qe {
        ...
        search(e, {limit: t=-1}={}) {
            ...
            return function(e, {ignoreFieldNorm: t=ye.ignoreFieldNorm}) {
                e.forEach((e => {
                    let i = 1;
            ...
            function(e, t, {includeMatches: i=ye.includeMatches, includeScore: n=ye.includeScore}={}) {
                const s = [];
                return i && s.push(He),
                n && s.push($e),
                e.map((e => {
    ...
    qe.version = "7.0.0",
    qe.createIndex = Ce,
    qe.parseIndex = function(e, {getFn: t=ye.getFn, fieldNormWeight: i=ye.fieldNormWeight}={}) {
    ...
    function(...e) {
        ...
        constructor(e, {isCaseSensitive: t=ye.isCaseSensitive, includeMatches: i=ye.includeMatches, minMatchCharLength: n=ye.minMatchCharLength, ignoreLocation: s=ye.ignoreLocation, findAllMatches: o=ye.findAllMatches, location: r=ye.location, threshold: c=ye.threshold, distance: a=ye.distance}={}) {
            this.query = null,
            this.options = {
                isCaseSensitive: t,
                includeMatches: i,
        ...
        searchIn(e) {
            ...
            for (let n = 0, c = t.length; n < c; n += 1) {
                ...
                for (let t = 0, n = c.length; t < n; t += 1) {
                    ...
                    s += 1,
                    r += l,
                    i && (Fe.has(n.constructor.type) ? o = [...o, ...h] : o.push(h))
                }
                if (s) {
                    let e = {
                        isMatch: !0,
    ...
    var We = function() {
        ...
        e.prototype.search = function(e) {
            return this._fuse || (this._fuse = new qe(this._haystack,this._fuseOptions)),
      ...
      , Ue = function(e, t, i) {
        ...
        i && s && ("string" == typeof s ? n.customProperties = s : "object" != typeof s || function(e) {
            for (var t in e)
      ...
      , ze = {
        containerOuter: function(e, t, i, n, s, o, r) {
            ...
            s ? a.setAttribute("aria-autocomplete", "list") : r || Ge(this._docRoot, this.passedElement.element.id, a),
        ...
        item: function(e, t, i) {
            ...
            this._isSelectElement && (f.setAttribute("aria-selected", "true"),
        ...
        choice: function(e, t, i, n) {
            ...
            m.setAttribute("aria-disabled", "true")) : (F(m, a),
        ...
        input: function(e, t) {
            ...
            t ? r.setAttribute("aria-label", t) : o || Ge(this._docRoot, this.passedElement.element.id, r),
            r
        },
        dropdown: function(e) {
            var t = e.classNames
        ...
        notice: function(e, t, i) {
            ...
            return i === ee && (l.dataset.choiceSelectable = "",
            l.dataset.choice = ""),
            l
        },
        option: function(e) {
    ...
    return function() {
        function e(t, n) {
            ...
            "boolean" != typeof r.renderSelectedChoices && (r.renderSelectedChoices = "always" === r.renderSelectedChoices || u),
            r.closeDropdownOnSelect = "auto" === r.closeDropdownOnSelect ? l || u || r.singleModeForMultiSelect : $(r.closeDropdownOnSelect),
            r.placeholder && (r.placeholderValue ? this._hasNonChoicePlaceholder = !0 : a.dataset.placeholder && (this._hasNonChoicePlaceholder = !0,
            ...
            this.passedElement.isActive)
                return r.silent || console.warn("Trying to initialise Choices on element already initialised", {
                    element: t
                }),
                this.initialised = !0,
        ...
        e.prototype.highlightItem = function(e, t) {
            ...
            return !i || i.highlighted || (this._store.dispatch(C(i, !0)),
        ...
        e.prototype.unhighlightItem = function(e, t) {
            ...
            return i && i.highlighted ? (this._store.dispatch(C(i, !1)),
        ...
        e.prototype.highlightAll = function() {
            ...
            return this._store.withTxn((function() {
                e._store.items.forEach((function(t) {
                    t.highlighted || (e._store.dispatch(C(t, !0)),
        ...
        e.prototype.unhighlightAll = function() {
            ...
            return this._store.withTxn((function() {
                e._store.items.forEach((function(t) {
                    t.highlighted && (e._store.dispatch(C(t, !1)),
                    e.passedElement.triggerEvent(g, e._getChoiceForOutput(t)))
                }
                ))
            }
        ...
        e.prototype.setChoices = function(e, t, n, s, o) {
            ...
            "function" == typeof e) {
                ...
                if (!Array.isArray(c))
                    throw new TypeError(".setChoices first argument function must return either array of choices or Promise, got: ".concat(typeof c));
        ...
        e.prototype.clearInput = function() {
            return this.input.clear(!this._isSelectOneElement),
            this._stopSearch(),
            this
        }
        ,
        e.prototype._validateConfig = function() {
            var e, t, i, n = this.config, s = (e = z,
            ...
            n.allowHTML && n.allowHtmlUserInput && (n.addItems && console.warn("Warning: allowHTML/allowHtmlUserInput/addItems all being true is strongly not recommended and may lead to XSS attacks"),
            n.addChoices && console.warn("Warning: allowHTML/allowHtmlUserInput/addChoices all being true is strongly not recommended and may lead to XSS attacks"))
        }
        ,
        ...
        e.prototype._renderItems = function() {
            var e = this
              ...
              , r = function(t) {
                var i = t.itemEl;
                i && i.parentElement || (i = o(t) || e._templates.item(n, t, n.removeItemButton),
                t.itemEl = i,
                s.appendChild(i))
            };
            t.forEach(r);
            ...
            c && (i.append(s),
            n.shouldSortItems && !this._isSelectOneElement && (t.sort(n.sorter),
        ...
        e.prototype._displayNotice = function(e, t, i) {
            void 0 === i && (i = !0);
            var n = this._notice;
            n && (n.type === t && n.text === e || n.type === ee && (t === Z || t === Y)) ? i && this.showDropdown(!0) : (this._clearNotice(),
            this._notice = e ? {
                text: e,
                type: t
            } : void 0,
        ...
        e.prototype._handleBackspace = function(e) {
            ...
            if (t.removeItems && e.length) {
                ...
                t.editItems && !n && i ? (this.input.value = i.value,
                this.input.setWidth(),
                this._removeItem(i),
                this._triggerChange(i.value)) : (n || this.highlightItem(i, !1),
        ...
        e.prototype._canCreateItem = function(e) {
            ...
            i) {
                ...
                if (this._isSelectElement) {
                    if (s)
                        return this._displayNotice("", ee),
                        !1
                } else
                    this._isTextElement && !t.duplicateItemsAllowed && s && (i = !1,
                    n = x(t.uniqueItemText, e))
            }
            return i && (n = x(t.addItemText, e)),
        ...
        e.prototype._searchChoices = function(e) {
            ...
            this._isSearching = !0;
            var s = this._notice;
            return (s && s.type) !== ee && (n.length ? this._clearNotice() : this._displayNotice(A(this.config.noResultsText), Z)),
        ...
        e.prototype._onKeyDown = function(e) {
            ...
            !this.input.isFocussed && n && (this.input.value += e.key,
        ...
        e.prototype._onDirectionKey = function(e, t) {
            ...
            if (t || this._isSelectOneElement) {
                ...
                if (e.metaKey || 34 === o || 33 === o)
                    c = this.dropdown.element.querySelector(r > 0 ? "".concat(Ye, ":last-of-type") : Ye);
                else {
                ...
                void 0 === (s = r) && (s = 1),
                (s > 0 ? n.scrollTop + n.offsetHeight >= i.offsetTop + i.offsetHeight : i.offsetTop >= n.scrollTop) || this.choiceList.scrollToChildElement(c, r),
        ...
        e.prototype._onMouseDown = function(e) {
            ...
            if (t instanceof HTMLElement) {
                ...
                if (t !== this.input.element) {
                    ...
                    n instanceof HTMLElement && ("button"in n.dataset ? this._handleButtonAction(n) : "item"in n.dataset ? this._handleItemAction(n, e.shiftKey) : "choice"in n.dataset && this._handleChoiceAction(n)),
                    e.preventDefault()
                }
            }
        }
        ...
        e.prototype._onFocus = function(e) {
            ...
            if (t && i.element.contains(t)) {
                ...
                this._isTextElement ? n && i.addFocusState() : this._isSelectMultipleElement ? n && (this.showDropdown(!0),
        ...
        e.prototype._onBlur = function(e) {
            ...
            if (t && i.element.contains(t) && !this._isScrollingOnIe) {
                var n = t === this.input.element;
                this._isTextElement || this._isSelectMultipleElement ? n && (i.removeFocusState(),
                this.hideDropdown(!0),
                this.unhighlightAll()) : (i.removeFocusState(),
                (n || t === i.element && !this._canSearch) && this.hideDropdown(!0))
            } else
                this._isScrollingOnIe = !1,
        ...
        e.prototype._addItem = function(e, t, i) {
            ...
            t && (this.passedElement.triggerEvent("addItem", this._getChoiceForOutput(e)),
            i && this.passedElement.triggerEvent("choice", this._getChoiceForOutput(e)))
        }
        ,
        e.prototype._removeItem = function(e) {
            e.id && (this._store.dispatch(E(e)),
        ...
        e.prototype._findAndSelectChoiceByValue = function(e, t) {
            ...
            return !(!n || n.disabled || n.selected || (this._addItem(n, !0, t),
            0))
        }
        ,
